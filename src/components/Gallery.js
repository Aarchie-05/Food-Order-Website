    ...
    render(){
        ...
        return (
            ...
            <OwlCarousel className="owl-theme" loop responsiveClass autoplay>
                ...
                <h1 style={{position: "absolute",bottom: "8px",right: "16px",color:"white",fontSize:"6rem"}}>Pizza</h1>
                </div>
                <div class="item" style={{margin:"2rem"}}>
                ...
                <h1 style={{position: "absolute",bottom: "8px",right: "16px",color:"white",fontSize:"6rem"}}>Pasta</h1>
                </div>
                <div class="item" style={{margin:"2rem"}}>
                ...
                <h1 style={{position: "absolute",bottom: "8px",right: "16px",color:"white",fontSize:"6rem"}}>Chinese</h1>
                </div>
                <div class="item" style={{margin:"2rem"}}>
                ...
                <h1 style={{position: "absolute",bottom: "8px",right: "16px",color:"white",fontSize:"6rem"}}>Indian</h1>
                </div>
                <div class="item" style={{margin:"2rem"}}>
                ...
                <h1 style={{position: "absolute",bottom: "8px",right: "16px",color:"white",fontSize:"6rem"}}>Drinks</h1>
                </div>
                <div class="item" style={{margin:"2rem"}}>
                ...
                <h1 style={{position: "absolute",bottom: "8px",right: "16px",color:"white",fontSize:"6rem"}}>Desserts</h1>
                </div>
            </OwlCarousel>
            </div>
        );
